...
class Hotels
{
	...
	{
		$html="";
		$html = $html. "<p> $this->name  -   $this->price р.</p>";
		...
		if (!empty($this->line))$line_html= "<li class='hotel__fact-container'>
			...
			$this->pansion = $this->GetPansionFromCode($this->pansion);
												...
												<a class='card-main_gate__link' href='$this->hotel_url' target='_blank'>
													<div class='main_gate-price_info'>
													  <div class='main_gate-price'>
														<span class='currency_font'>$this->price р.</span>
													  </div>
													  <div class='main_gate-stay_period'>
														Цена за $this->nightcount ноч.
													  </div>
													</div>
											...
											<div class='col-md-5 col-sm-5 col-xs-12'>
												<div class='hotel__info row'>
													...
													<div class='hotel__info-bottom'>
													  <div class='hotel__pricing'>
														<div class='hotel__bottom-row'>
															<span class='hotel__order-params'>$this->touristcount чел./$this->nightcount ночей</span>
															<br/>
															<span class='hotel__order-params'>Питание: $this->pansion</span>
														</div>
													   </div>
