...
$APPLICATION->SetPageProperty("keywords", "шри ланка авиабилеты шри-ланка билеты на самолет дешевые авиабилеты шри-ланка купить");
$APPLICATION->SetPageProperty("description", "Дешевые авиабилеты на Шри-Ланку. Поиск и сравнение цен билетов на самолет. Забронируйте билеты на Шри-Ланку онлайн.");
$APPLICATION->SetPageProperty("title", "Купить авиабилеты на Шри-Ланку - поиск дешевых билетов на самолет, лучшие цены");
$APPLICATION->SetTitle("Авиабилеты в Шри-Ланку");
?>
<main class="directions sect_avia sri-lanka">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			
			<img class="main_img" src="/local/templates/general_2/img/avia_background_big_sri_lanka.png" alt="">
			<h1>Авиабилеты в Шри-Ланку</h1>
		</div>		
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&to_name=%D0%A8%D1%80%D0%B8-%D0%9B%D0%B0%D0%BD%D0%BA%D0%B0&locale=ru&currency=USD&powered_by=true" charset="utf-8"></script>
						</li>
						...
						<!--<li class="js_tab_content_1" data-tab="4">
							<script charset="utf-8" src="//partner.onetwotrip.com/build/widget/form.widget.load.js?id=32318&v=2" data-avia="true" avia-from="MOW" avia-to="CMB"  async></script>
						</li>-->							
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/shrilankaSEO/avia.php"
				),
				false
			);?>
	</div>
