...
$APPLICATION->SetPageProperty("keywords", "шри-ланка отели лучшие отели шри-ланки отели хиккадува  унаватуна   все включено 5 звезд");
$APPLICATION->SetPageProperty("description", "Бронирование отелей Шри-Ланки без комиссии. Популярные отели всё включено и 5 звезд. Отдых в лучших отелях Хиккадувы и Унаватуны");
$APPLICATION->SetPageProperty("title", "Отели Шри-Ланки - цены, онлайн бронирование лучших отелей в Шри-Ланке");
$APPLICATION->SetTitle("Отели Шри-Ланки");
?><main class="directions sri-lanka sect_hotels">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/hotels_background_big_sri_lanka.png" alt="">
			<h1>Отели Шри-Ланки</h1>
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1 " data-tab="2">
							<script charset="utf-8" src="//partner.onetwotrip.com/build/widget/form.widget.load.js?id=32320&v=2" data-hotels="true" place="79" place-type="tourism"  async></script>	
						</li>-->						
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%A8%D1%80%D0%B8-%D0%9B%D0%B0%D0%BD%D0%BA%D0%B0&border_radius=5&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		<!--<div class="search_system_wrapper">
			...
			<ul class="search_system_list">
				...
				<li class="js_tab_trigger_1 active logo_box_item" data-tab="1">
					<div class="tip">
			...
			<ul class="useful_list">
				<li class="useful_list_item">
					<a href="/napravleniya/sri-lanka/tours/">
						...
						<p class="useful_list_name">Туры на Шри-Ланку</p>
					</a>				
				</li>
				<li class="useful_list_item">
				...
				array(
					...
					"PATH" => "/include/shrilankaSEO/hotel.php"
				),
				false
			);?>
