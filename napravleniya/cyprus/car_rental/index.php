...
$APPLICATION->SetPageProperty("title", "U-TRAVELL - Прокат авто на Кипре");
$APPLICATION->SetTitle("Прокат авто на Кипре");
?>

<main class="directions cyprus sect_car_rental">
	
	<section class="main_search" id="main_search">
		<div class="container">
			<img class="main_img" src="<?=SITE_TEMPLATE_PATH?>/img/car_background_big_thai.png" alt="">
			<h1>Прокат авто на Кипре</h1>
		...
		<div class="container">
			...
			<ul class="search_form_list">
				<li class="js_tab_content_1 active" data-tab="1">
					<script src="https://c10.travelpayouts.com/content?promo_id=2109&shmarker=200556&locale=ru&border_radius=0px&button_color=%2300C7CB&input_border_radius=false&logo=false&hide_header=true&full_width=true&pick_up=LCA&powered_by=true" charset="utf-8" async="true"></script>	
				</li>
				<li class="js_tab_content_1" data-tab="2">
					<script src="https://c52.travelpayouts.com/content?promo_id=1757&shmarker=200556&color_scheme=bright&border_radius=5px&input_border_radius=true&logo=true&hide_header=true&pick_up=LCA&powered_by=true" charset="utf-8" async="true"></script>
				</li>
				...
				<li class="js_tab_content_1" data-tab="5">
					<script src="https://c117.travelpayouts.com/content?promo_id=3873&shmarker=200556&location=cyprus&locale=ru&bg_color=fff&font_color=2A3D71&button_color=1bc3e5%20&button_font_color=fff&powered_by=true" charset="utf-8" async="true"></script>
				</li>
			</ul>
		</div>
