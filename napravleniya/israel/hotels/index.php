...
$APPLICATION->SetPageProperty("title", "Лучшие отели Израиля - онлайн бронирование отелей по низким ценам");
$APPLICATION->SetTitle("Отели в Израиле");
?><main class="directions israel sect_hotels">
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%98%D0%B7%D1%80%D0%B0%D0%B8%D0%BB%D1%8C&border_radius=5&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/israelSEO/hotel.php"
				),
				false
			);?>
