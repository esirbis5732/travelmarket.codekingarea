...
$APPLICATION->SetPageProperty("keywords", "эмираты билеты на самолет дешевые авиабилеты в ОАЭ эмираты цены купить");
$APPLICATION->SetPageProperty("description", "Дешевые авиабилеты в ОАЭ. Поиск и сравнение цен билетов на самолет в Арабские Эмираты. Забронируйте билеты в ОАЭ.");
$APPLICATION->SetPageProperty("title", "Купить авиабилеты в ОАЭ - дешевые билеты на самолет в Арабские Эмираты");
$APPLICATION->SetTitle("Авиабилеты в Эмираты");
?>
<main class="directions sect_avia thailand">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/avia_background_big_uae.png" alt="">
			<h1>Авиабилеты в Эмираты</h1>
		...
		<div class="container">				
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&to_name=%D0%9E%D0%90%D0%AD&locale=ru&currency=RUB&powered_by=true" charset="utf-8"></script>
						</li>
