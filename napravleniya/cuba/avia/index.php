...
$APPLICATION->SetPageProperty("keywords", "куба билеты на самолет дешевые авиабилеты на кубу купить билет на кубу");
$APPLICATION->SetPageProperty("description", "Дешевые авиабилеты на Кубу. Поиск и сравнение цен и бронирование билетов на самолет. Купите билеты на Кубу онлайн.");
$APPLICATION->SetPageProperty("title", "Дешевые авиабилеты на Кубу - купить билет на самолет по лучшей цене");
$APPLICATION->SetTitle("Авиабилеты на Кубу");
?>
<main class="directions sect_avia cuba">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/avia_background_big_cuba.png" alt="">
			<h1>Авиабилеты на Кубу</h1>
		...
		<div class="container">				
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B2&to_name=%D0%9A%D1%83%D0%B1%D0%B0&locale=ru&currency=RUB&powered_by=true" charset="utf-8"></script>
						</li>
						...
						<!--<li class="js_tab_content_1" data-tab="4">
							<script charset="utf-8" src="//partner.onetwotrip.com/build/widget/form.widget.load.js?id=32314&v=2" data-avia="true" avia-from="MOW" avia-to="MOA"  async></script>
						</li>-->							
					</ul>
		</div>
