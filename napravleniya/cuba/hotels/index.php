...
$APPLICATION->SetPageProperty("keywords", "куба отели варадеро  ольгин отель меморис отель амиго санта мария");
$APPLICATION->SetPageProperty("description", "Онлайн бронирование отелей Кубы. Популярные отели по низким ценам. Отдых в лучших отелях Варадеро, Ольгин, Санта-Марии");
$APPLICATION->SetPageProperty("title", "Отели Кубы - онлайн бронирование отелей и гостиниц Кубы по низким ценам");
$APPLICATION->SetTitle("Отели на Кубе");
?>
<main class="directions cuba sect_hotels">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/hotels_background_big_cuba.png" alt="">
			<h1>Отели на Кубе</h1>
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1 " data-tab="2">
							<script charset="utf-8" src="//partner.onetwotrip.com/build/widget/form.widget.load.js?id=32315&v=2" data-hotels="true" place="3553478" place-type="geo"  async></script>	
						</li>-->						
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%BA%D1%83%D0%B1%D0%B0&border_radius=7&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/kubaSEO/hotel.php"
				),
				false
			);?>
	</div>
