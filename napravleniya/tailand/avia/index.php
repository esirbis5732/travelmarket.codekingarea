...
$APPLICATION->SetPageProperty("keywords", "купить авиабилеты в тайланд билеты на самолет в тайланд дешевые авиабилеты в таиланд цена авиабилет таиланд  пхукет");
$APPLICATION->SetPageProperty("description", "Дешевые авиабилеты в Таиланд . Поиск и сравнение цен билетов на самолет в Таиланд. Забронируйте билеты в Паттайю и Пхукет.");
$APPLICATION->SetPageProperty("title", "Купить авиабилеты в Таиланд - поиск дешевых билетов на самолет, лучшие цены");
$APPLICATION->SetTitle("Авиабилеты в Таиланд");
?><main class="directions sect_avia thailand">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/avia_background_big_thai.png" alt="">
			<h1>Авиабилеты в Таиланд</h1>
		...
		<div class="container">			
					...
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&to_name=%D0%A2%D0%B0%D0%B8%D0%BB%D0%B0%D0%BD%D0%B4&locale=ru&currency=RUB&primary_color=00C7CB&results_background_color=ffffff&form_background_color=ffffff&search_form_color1=2A3D71&search_form_color2=ffffff&powered_by=true" charset="utf-8"></script>
						</li>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/tailandSEO/avia.php"
				),
				false
			);?>
