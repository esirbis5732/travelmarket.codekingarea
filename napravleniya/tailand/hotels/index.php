...
$APPLICATION->SetPageProperty("keywords", "тайланд пхукет отели паттайя лучшие отели тайланда отель резорт карон отель цены патонг");
$APPLICATION->SetPageProperty("description", "Дешевые отели Таиланда. Лучшие отели Пхукета и Паттайи по низким ценам.  Бронирование отелей Таиланда по минимальным ценам.");
$APPLICATION->SetPageProperty("title", "Лучшие отели Таиланда - онлайн бронирование отелей по низким ценам");
$APPLICATION->SetTitle("Отели в Таиланде");
?><main class="directions thailand sect_hotels">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/hotels_background_big_thai.png" alt="">
			<h1>Отели в Таиланде</h1>
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%A2%D0%B0%D0%B8%D0%BB%D0%B0%D0%BD%D0%B4&border_radius=5&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/tailandSEO/hotel.php"
				),
				false
			);?>
