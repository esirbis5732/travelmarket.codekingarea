...
$APPLICATION->SetPageProperty("keywords", "билеты на самолет во вьетнам дешевые авиабилеты во вьетнам купить билет");
$APPLICATION->SetPageProperty("description", "Дешевые авиабилеты во Вьетнам. Поиск и сравнение цен билетов на самолет. Забронируйте билеты во Вьетнам онлайн.");
$APPLICATION->SetPageProperty("title", "Купить авиабилеты во Вьетнам - поиск дешевых билетов на самолет, лучшие цены");
$APPLICATION->SetTitle("Авиабилеты во Вьетнам");
?>
<main class="directions sect_avia vietnam">
	<section class="main_search anchor_scroll" id="main_search">
		<div class="container">
			<img class="main_img" src="/local/templates/general_2/img/avia_background_big_vietnam.png" alt="">
			<h1>Авиабилеты во Вьетнам</h1>
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&to_name=%D0%92%D1%8C%D0%B5%D1%82%D0%BD%D0%B0%D0%BC&locale=ru&currency=RUB&powered_by=true" charset="utf-8"></script>
						</li>
						...
						<!--<li class="js_tab_content_1" data-tab="4">
							<script charset="utf-8" src="//partner.onetwotrip.com/build/widget/form.widget.load.js?id=32323&v=2" data-avia="true" avia-from="MOW" avia-to="HAN"  async></script>
						</li>-->							
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/vietnamSEO/avia.php"
				),
				false
			);?>
	</div>
