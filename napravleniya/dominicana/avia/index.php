...
$APPLICATION->SetTitle("Авиабилеты в Доминикану");
?><main class="directions sect_avia dominicana">
		...
		<div class="container">			
					...
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="2">
							<script src="//c111.travelpayouts.com/content?promo_id=3411&shmarker=200556&from_name=MOW&to_name=DO&locale=ru&currency=RUB&primary_color=00C7CB&results_background_color=ffffff&form_background_color=ffffff&search_form_color1=2A3D71&search_form_color2=ffffff&powered_by=true" charset="utf-8"></script>
						</li>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/dominicanaSEO/avia.php"
				),
				false
			);?>
