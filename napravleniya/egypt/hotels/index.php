...
$APPLICATION->SetPageProperty("title", "Лучшие отели Египта - онлайн бронирование отелей по низким ценам");
$APPLICATION->SetTitle("Отели в Египте");
?><main class="directions egypt sect_hotels">
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%95%D0%B3%D0%B8%D0%BF%D0%B5%D1%82&border_radius=5&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/egyptSEO/hotel.php"
				),
				false
			);?>
