...
$APPLICATION->SetPageProperty("keywords", "Тунис отели лучшие отели Туниса  цены ");
$APPLICATION->SetPageProperty("description", "Дешевые отели Туниса. Лучшие отели Туниса по низким ценам.  Бронирование отелей Туниса по минимальным ценам.");
$APPLICATION->SetPageProperty("title", "Лучшие отели Туниса - онлайн бронирование отелей по низким ценам");
$APPLICATION->SetTitle("Отели в Тунисе");
?><main class="directions tunisia sect_hotels">
		...
		<div class="container">			
					<ul class="search_form_list">
						...
						<!--<li class="js_tab_content_1" data-tab="3">
							<script src="//tp.media/content?promo_id=3610&shmarker=200556&campaign_id=118&locale=ru&default_direction=%D0%A2%D1%83%D0%BD%D0%B8%D1%81&border_radius=5&plain=true&powered_by=true" charset="utf-8"></script>
						</li>-->
					</ul>
		</div>
		...
		<h2>Смотрите также</h2>
			<ul class="useful_list">
				...
				array(
					...
					"PATH" => "/include/tunisiaSEO/hotel.php"
				),
				false
			);?>
