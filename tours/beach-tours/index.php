...
<div class="container">
	<img class="main_img" src="<?=SITE_TEMPLATE_PATH?>/img/beach_tours_background_big.png" alt="">
	<h1>Пляжные туры</h1>
...
<div class="container">
	...
	<a class="logo_box_item" target="_blank" href="https://ad.admitad.com/g/7v8gnyf9f2d76d4286da1be5ac5012/">
		<div class="tip">
			Алеан - лидер среди компаний, организующих отдых на курортах РФ. Ежегодно по результатам различных рейтингов Алеан занимает верхние строчки предпочтений среди агентств и туристов. Сегодня в России, Беларуси и Азербайджане работает 12 офисов и представительств, обеспечивающих организованный отдых на российских курортах, в странах СНГ и Прибалтики. 
			<span class="close"> </span>
		</div>
		<img alt="Alean" src="/local/templates/general_2/img/logo_min/alean.jpg">
	</a>	
	<a class="logo_box_item" target="_blank" href="https://ad.admitad.com/g/qgduo66x9id76d4286da69b991bd5d/">
		...
		<img alt="Delfin Tour" src="/local/templates/general_2/img/logo_min/delfin_tour.jpg">
	</a>	
	<a class="logo_box_item" target="_blank" href="https://ad.admitad.com/g/6ef7bcadc9d76d4286da4c15c68865/">
		...
		<img alt="Ozon travel" src="/local/templates/general_2/img/logo_min/ozon_travel.png">
	</a>	
	<a class="logo_box_item" target="_blank" href="https://ad.admitad.com/g/24oby4leusd76d4286da59fafa9a7f/">
		<div class="tip">
			Tez Tour - международный туристический оператор. Лидер по отправке туристов из России, стран бывшего СНГ и Восточной Европы. Основан в 1994 году.
			<span class="close"> </span>
		</div>
		<img alt="Tez Tour" src="/local/templates/general_2/img/logo_min/tez_tour.png">
	</a>	
	<!--<a class="logo_box_item" target="_blank" href="https://ad.admitad.com/g/239cb0bc31d76d4286dabf3e570a18/?ulp=https%3A%2F%2Ftours.svyaznoy.travel%2F">
		<div class="tip">
	...
	<a class="logo_box_item" target="_blank" href="https://c47.travelpayouts.com/click?shmarker=200556&promo_id=1944&source_type=link&type=click">
		<div class="tip">
			Viator — ведущий мировой ресурс для поиска и бронирования лучших путешествий по всему миру. Viator.com, вы будете предоставляет своим клиентам онлайн доступ к тысячам мероприятий, включая туры, аттракционы, групповые и частные экскурсии в более чем 2700 направлениях по всему миру. 
			<span class="close"> </span>
		</div>
		<img alt="Viator" src="/local/templates/general_2/img/viator.png">
	</a>	
	</section>
	...
	<div class="inclusion" id="inclusion" data-aos="fade-up">
		<a href="/napravleniya/otdykh-na-more-v-mae/">
			...
			<img class="main_img" src="<?=SITE_TEMPLATE_PATH?>/img/mai.png" alt="Куда поехать на море в мае?">
		</a>
	</div>
	...
	<!--<section  id="tour_selection" class="tour_selection anchor_scroll">
	...
	<div id="tabs_1" class="last_minute_tours_item js_tab_content active" data-tab="1" data-aos="fade-up">
		...
		<!--Tutu.ru-->
		<!--<div id="country_197" class="mt-40">
			<script>
	...
	<div id="tabs_2" class="last_minute_tours_item js_tab_content" data-tab="2">
		...
		<!--Tutu.ru-->
		<!--<div id="country_188" class="mt-40">
			<script>
	...
	<div id="tabs_3" class="last_minute_tours_item js_tab_content" data-tab="3" >
		...
		<!--Tutu.ru-->
		<!--<div id="country_145" class="mt-40">
			<script>
	...
	<div id="tabs_7" class="last_minute_tours_item js_tab_content" data-tab="7" >
		...
		<div>
			...
			<script src="https://c18.travelpayouts.com/content?promo_id=1490&shmarker=200556&table=true&rows=2&columns=5&cellWidth=auto&countries=26&powered_by=true" charset="utf-8" async></script>
		</div>
		<!--Tutu.ru-->
		<!--<div id="country_64" class="mt-40">
			<script>
	...
	<div id="tabs_11" class="last_minute_tours_item js_tab_content" data-tab="11">
		...
		<!--Tutu.ru-->
		<!--<div id="country_125" class="mt-40">
			<script>
 ...
 <!--<section class="tutu_last_minute_tours">
