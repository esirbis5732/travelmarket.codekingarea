...
<main>
	...
	<div style="width:30%;padding: 0 10px 0 10px;">
		<div class="img">
	...
	<div style="width:70%; padding: 0 10px 0 10px;">
			<p>Страница не найдена</p>
			<p>Неправильно набран адрес или такой страницы не существует<p>
			<a href="<?=SITE_DIR?>"><span style="color: #1569bc;">Перейти на главную</span></a>
			<div class="back404">или <a style="color: #1569bc;" onclick="history.back()">вернуться назад</a></div>
	</div>
</div>
</main>
<script>
