...
$APPLICATION->SetPageProperty("twitter:image", "https://u-travell.ru/local/templates/general_2/img/avia_wide_og_tw.png");
$APPLICATION->SetPageProperty("fb:image", "https://u-travell.ru/local/templates/general_2/img/avia_wide_og_tw.png");
$APPLICATION->SetPageProperty("vk:image", "https://u-travell.ru/local/templates/general_2/img/avia_wide_og_vk.png");
$APPLICATION->SetPageProperty("og:image", "https://u-travell.ru/local/templates/general_2/img/avia_wide_og_tw.png");
...
<main id="main_search" class="avia">
			...
			<section class="logo_box">
				...
				<!--<a target="_blank" href="https://ad.admitad.com/g/c3c08bdc8fd76d4286da09315e6c64/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/city_travel.png" alt="City.Travel"></a>-->
				<!--<a target="_blank" href="https://ad.admitad.com/g/5k6m2qm7z5d76d4286da90465e1588/?ulp=https%3A%2F%2Fwww.compensair.com%2Fru%2Fcheck-flight.html"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/compensair.png" alt="Compensair"></a>-->
				<!--<a target="_blank" href="https://ad.admitad.com/g/jmv9kwepx1d76d4286da28c1090438/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/etihad_airways.jpg" alt="Etihad Airways"></a>-->
				...
				<!--<a target="_blank" href="https://ad.admitad.com/g/hrw43drre7d76d4286dacb4402ea55/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/trip_my_dream.png" alt="TripMyDream"></a>-->
				...
				<!--<a target="_blank" href="https://ad.admitad.com/g/7z8rbci6j9d76d4286da2a35947101/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/vegas_com.jpg" alt="Vegas "></a>-->
				<!--<a target="_blank" href="https://ad.admitad.com/g/bclmc6k6vid76d4286da0d13f2a7f0/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/volotea.png" alt="Volotea"></a>-->
				...
				<!--<a target="_blank" href="https://ad.admitad.com/g/1f8fa00febd76d4286dad9449647fe/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo_min/tuturu.png" alt="Туту.ру"></a>-->
				...
				<section class="popular revealator-slideup anchor_scroll" data-aos="fade-up" id="popular">
				...
				<section class="special revealator-slideup anchor_scroll" data-aos="fade-up" id="special">
					<div class="slides_n big_block">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include", 
						"template1", 
					...
					<div class="slides_n big_block mob">
						<?$APPLICATION->IncludeComponent(
							...
							array(
								...
								"COMPONENT_TEMPLATE" => "template1",
								"AREA_FILE_RECURSIVE" => "Y",
								"PATH" => "/include/slider_1b_mob.php"
							),
							false
						);?>
					</div>
				...
				<section class="calendar revealator-slideup anchor_scroll" data-aos="fade-up" id="calendar">
					<div class="slides_n big_block">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include", 
						"template1", 
					...
					<div class="slides_n big_block mob">
						<?$APPLICATION->IncludeComponent(
							...
							array(
								...
								"COMPONENT_TEMPLATE" => "template1",
								"AREA_FILE_RECURSIVE" => "Y",
								"PATH" => "/include/slider_1c_mob.php"
							),
							false
						);?>
					</div>
				...
				<section class="schedule revealator-slideup anchor_scroll" data-aos="fade-up" id="schedule">
					<div class="slides_n big_block">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include", 
						"template1", 
					...
					<div class="slides_n big_block mob">
						<?$APPLICATION->IncludeComponent(
							...
							array(
								...
								"COMPONENT_TEMPLATE" => "template1",
								"AREA_FILE_RECURSIVE" => "Y",
								"PATH" => "/include/slider_1d_mob.php"
							),
							false
						);?>
					</div>
					...
					<div class="slides_n big_block mob">
						<?$APPLICATION->IncludeComponent(
							...
							array(
								...
								"COMPONENT_TEMPLATE" => "template1",
								"AREA_FILE_RECURSIVE" => "Y",
								"PATH" => "/include/slider_1e_mob.php"
							),
							false
						);?>
					</div>
				...
				<div class="slides_n big_block" id="compens">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include", 
						"template1", 
						array(
				...
				<div class="slides_n big_block mob">
					<?$APPLICATION->IncludeComponent(
						...
						array(
							...
							"COMPONENT_TEMPLATE" => "template1",
							"AREA_FILE_RECURSIVE" => "Y",
							"PATH" => "/include/slider_1f_mob.php"
						),
						false
					);?>
				</div>
				<section class="compens revealator-slideup anchor_scroll" data-aos="fade-up">		
