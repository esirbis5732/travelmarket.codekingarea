...
<?if($arResult["NavPageCount"] > 1):?>
	...
	?>
	<?if(!$bNextDisabled){?>
		<?if ($arResult["NavNum"] <= $arResult["NavPageCount"] && $arResult["NavPageNomer"] != $arResult["NavPageCount"] && $arResult["nEndPage"]<=$arResult["NavPageCount"]):?>
			<div class="ajax_load_btn">
				<a id="ajax_next_page" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=(++$arResult["NavPageNomer"])?>" class="dark_link"><?=GetMessage('PAGER_SHOW_MORE')?></a>
